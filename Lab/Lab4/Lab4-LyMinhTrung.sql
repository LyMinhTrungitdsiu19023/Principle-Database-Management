...
/*Author Ly Minh Trung - ITDSIU19023*/ /*Include Lab 2 3 and 4*/
...
JOIN CustomerDetails.CustomerProducts cp ON cp.CustomerId = c.CustomerId
JOIN CustomerDetails.FinancialProducts fp ON
fp.ProductId = cp.FinancialProductIdGOALTER TABLE CustomerDetails.Customers				/*FAIL*/
...
REFERENCES ShareDetails.Shares(ShareId)
GO */
ALTER TABLE CustomerDetails.FinancialProducts  WITH CHECK ADD  CONSTRAINT [FK_CustomerProducts_FinancialProducts] FOREIGN KEY(ProductId)
REFERENCES CustomerDetails.CustomerProducts (CustomerFinancialProductId)
GO 
ALTER TABLE TransactionDetails.Transactions WITH CHECK ADD  CONSTRAINT [FK_TransactionTypes_Transactions] FOREIGN KEY(TransactionType)
REFERENCES TransactionDetails.TransactionTypes (TransactionTypeId)
GO 
